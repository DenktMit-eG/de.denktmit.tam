...
import de.denktmit.tam.persistence.repository.TimeSheetRecordRepository;
import de.denktmit.tam.business.service.TimeSheetRecordService;
...
public class TimeSheetRecordServiceImpl implements TimeSheetRecordService {
    ...
    public List<TimeSheetRecordEntity> convertFilestreamToTimeSheetRecordEntities(InputStream inputStream,
        ...
        while ((nextRecord = csvReader.readNext()) != null) {
            try {
                timeSheetRecordEntities.add(CSVMapper.mapTimeSheetRecord(workRecord, nextRecord));
